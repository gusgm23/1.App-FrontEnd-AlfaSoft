...
export const HomeScreen = () => {
    return (
        <>
            <h2 className='titulo-home animate__animated animate__fadeIn'>Sistema de Asignación de Aulas</h2>
            <hr/>
            <div className='contenido-home'>
                ...
                <img className='animate__animated animate__fadeIn' src={homeImg}/>
            </div>
        </>
    )
}
